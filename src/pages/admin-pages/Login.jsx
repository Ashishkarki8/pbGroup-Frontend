...
// // ========================================
// // LOGIN PAGE WITH CENTERED MODAL DESIGN
// // pages/admin-pages/Login.jsx
// // ========================================
...
// // ========================================
// // LOGIN COMPONENT (CENTERED MODAL STYLE)
// // ========================================
// const Login = () => {
//   const navigate = useNavigate();
//   const { isAuthenticated } = useAuthStore();
...
//   // ========================================
//   // RENDER: CENTERED MODAL DESIGN
//   // Same style as your PosterModal!
//   // ========================================
//   return (
//     <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8">
//       {/* Blurred Background Overlay (like poster modal) */}
//       <div className="absolute inset-0 bg-black/40 backdrop-blur-md" />

//       {/* Centered Login Form (like poster modal content) */}
//       <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden z-20 w-full max-w-md">
//         <div className="p-8">
//           {/* Header */}
//           <div className="text-center mb-8">
//             <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-100 rounded-full mb-4">
...
// // ========================================
// // LOGIN PAGE USING MODAL COMPONENT
// // pages/admin-pages/Login.jsx
// // ========================================
...
// import { z } from 'zod';
// import { LockKeyhole, User, Eye, EyeOff } from 'lucide-react';
// import Modal from '../../components/modals/Modal'; // ✅ REUSE YOUR MODAL!
// import useAuth from '../../hooks/useAuth';
// import useAuthStore from '../../store/authStore';
// import { ROUTES } from '../../utils/constants';
...
//   // Same as your PosterModal setup!
//   // ========================================
//   return (
//     <Modal
//       isOpen={true} // Always open when this page is visited
//       onClose={() => {}} // No close button for login page
//       maxWidth="max-w-md"
//       className="p-0"
//       closeOnOverlayClick={false} // Can't close by clicking outside
//       closeOnEsc={false} // Can't close with ESC key
//     >
//       <div className="p-8">
//         {/* Header */}
//         <div className="text-center mb-8">
